...
int ebuRead1(ebuImage *data, FILE *fileName1)
{
    ...
    data->imageData1 = (unsigned char *)malloc(data->numBytes1 * sizeof(unsigned char));
    ...
    {
        // reading in
        check = fscanf(fileName1, "%c", &data->tempPixel1);
...
int ebuRead2(ebuImage *data, FILE *fileName2)
{
    ...
    data->imageData2 = (unsigned char *)malloc(data->numBytes2 * sizeof(unsigned char));
    ...
    {
        // reading in
        check = fscanf(fileName2, "%c", &data->tempPixel2);
