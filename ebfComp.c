...
int main(int argc, char **argv)
{
    ...
    int ebfRead1(ebfImage *data, FILE *fileName1);
    int ebfRead2(ebfImage *data, FILE *fileName2);
    ...
    ebfImage *data = malloc(sizeof(ebfImage));

    int value1 = ebfRead1(data, inputFile1);
    ...
    int value2 = ebfRead2(data, inputFile2);
