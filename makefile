...
EXE    = ebfEcho ebfComp ebuEcho ebuComp ebcEcho ebcComp
...
ebfEcho: ebfEcho.o ebfRead.o
	$(CC) $(CCFLAGS) $^ -o $@

ebfComp: ebfComp.o ebfRead.o
	$(CC) $(CCFLAGS) $^ -o $@

ebuEcho: ebuEcho.o ebuRead.o
	$(CC) $(CCFLAGS) $^ -o $@

ebuComp: ebuComp.o ebuRead.o
	$(CC) $(CCFLAGS) $^ -o $@

ebcEcho: ebcEcho.o ebcRead.o
	$(CC) $(CCFLAGS) $^ -o $@

ebcComp: ebcComp.o ebcRead.o
	$(CC) $(CCFLAGS) $^ -o $@