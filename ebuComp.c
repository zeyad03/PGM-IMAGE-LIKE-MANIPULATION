...
int main(int argc, char **argv)
{
    ...
    int ebuRead1(ebuImage *data, FILE *inputFile1);
    //int ebuRead2(ebuImage *data, FILE *inputFile2);
    ...
    int value1 = ebuRead1(data, inputFile1);
    ...
    // capturing the value returned from readIn file
    int value2 = ebuRead2(data, inputFile2);
